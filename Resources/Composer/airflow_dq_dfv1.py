...
# Sample data
BUCKET_NAME = "test3425"
DATA_FILE_NAME = "emp.csv"
...
PROJECT_ID = "modern-tangent-332504"
DATASET = "employee"
TABLE = "emp"
...
with models.DAG(
    ...
    start_dataflow_job = DataflowTemplatedJobStartOperator(
        ...
        parameters={
            ...
            "javascriptTextTransformGcsPath": f"gs://{BUCKET_NAME}/csvtojson_transform.js",
            "JSONPath": f"gs://{BUCKET_NAME}/empSchema.json",
